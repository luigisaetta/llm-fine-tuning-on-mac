...
This notebook loads the local Qwen3-0.6B base model with the LoRA adapter created by Demo 01, then lets you ask any question through one editable prompt.

## Prerequisites

* Complete [Demo 01](../demo01/README.md) so the adapter exists under artifacts/training/demo01-qwen3-0.6b-lora/adapter/.
* Keep the base model under artifacts/models/Qwen3-0.6B/.
